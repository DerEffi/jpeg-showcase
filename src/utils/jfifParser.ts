...
export default class JFIFParser {
     ...
     */
    public static generateSegmentTable(data: Uint8Array) {
    ...
    public static parseAPP0(data: Uint8Array) {
        ...
        if(content.identifier === "JFIF" || data.byteLength < 18) {
            ...
            const major = data[9];
            const minor = data[10];
            content.version = major + "." + Formatter.padLeft(minor, 2);
