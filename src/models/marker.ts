...
export const segments: Segment[] = [
    ...
    { code: 0xFFE0, isFixedSize: false, hasSizeInfo: true, size: 2, shortName: "APP-0", name: "App specific", comment: "" },
    { code: 0xFFE1, isFixedSize: false, hasSizeInfo: true, size: 2, shortName: "APP-1", name: "App specific", comment: "" },
    ...
    { code: 0xFFEE, isFixedSize: false, hasSizeInfo: true, size: 2, shortName: "APP-E", name: "App specific", comment: "" },
