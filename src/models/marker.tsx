import { parseAPP0 } from "../utils/parser";
import { renderAPP0 } from "../utils/rederer";
...
export class Segment {
    ...
    static readonly DQT = new Segment(0xFFDB, "DQT", false, true, 2, "Define Quantization Table");
    static readonly COM = new Segment(0xFFFE, "COM", false, true, 2, "Comment");
    ...
    static readonly APP2 = new Segment(0xFFE2, "APP2", false, true, 2, "App specific");
    ...
    static readonly APP13 = new Segment(0xFFED, "APP13", false, true, 2, "App specific");
